...
class VerificationResult:
    ...
    Not part of what #116 asks for. Obligation 3 is the profile alone; this is here so
    a later reader can tell a run under an older profile from a run under the only
    profile on offer, which is obligation 4's information arriving through obligation
    3's field, and obligation 4 is deferred. Open question on the issue.
    """
